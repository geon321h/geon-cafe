	...
	<form name="myform" action="insertProc.jsp" method="post">
		...
		<table border=1>
			...
			<tr>
				<td>점수입력</td>
				<td>
					<span>C언어 : </span><input type="text" name="c" size="15">
					<br>
					<span>JAVA : </span><input type="text" name="java" size="15">
					<br>
					<span>JSP : </span><input type="text" name="jsp" size="15">
				</td>
			</tr>
